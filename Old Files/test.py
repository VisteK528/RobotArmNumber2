...
elbow = TMC2209(en=18, dir=8, step=7, resolution=0.9, gear_teeth=20)
...
elbow_roll_endstop = EndStop(SIGNAL_PIN=24, type="up")
...
elbow_pitch_endstop = EndStop(SIGNAL_PIN=25, type='up')
...
waist_joint.home()
waist_joint.set_angle(180)
print('Waist homed')


shoulder_joint.home(multipicator=0.5)
shoulder_joint.set_angle(17) # 17 offset
shoulder_joint.position=0
shoulder_joint.set_angle(90) # 17 offset
print("Shoulder homed")


elbow_joint.home()
elbow_roll_joint.home(offset=15)
